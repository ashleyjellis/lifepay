...
export async function DELETE(req: Request) {
  ...
  // Get all household IDs for this user
  const households = await db.execute({
  ...
  for (const hid of householdIds) {
    ...
    // Get all payday session IDs for cascade
    ...
    // Delete session_allocations (references pot + session)
    ...
    // Delete bills and debt_repayments
